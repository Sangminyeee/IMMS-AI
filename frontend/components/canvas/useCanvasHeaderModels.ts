...
export function useCanvasHeaderModels({
  ...
  const view = useMemo<CanvasHeaderViewState>(() => ({
    ...
    meetingTimerStartedAtMs: incomingView.meetingTimerStartedAtMs,
    meetingTimerEndedAtMs: incomingView.meetingTimerEndedAtMs,
    ...
    incomingView.meetingTimerEndedAtMs,
    incomingView.meetingTimerStartedAtMs,
